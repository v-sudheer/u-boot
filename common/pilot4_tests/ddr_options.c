...
int do_pilot4_ddrtest(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
        int i = 0;
        unsigned int config_no = 0;
        for(i = 0;i < argc;i++)
                printf("argv[%d] %s\n",i, argv[i]);
	if(strcmp("jump", argv[1]) == 0) {
		void (*jump)(unsigned int, unsigned char);
		if(argv[2] == NULL){
			printf("Enter the jump address\n");
			return -1;
		}
		jump = simple_strtoul (argv[2], NULL, 16);
		printf("Make sure program is loaded to this address %x\n",jump);
        ...
        if(argv[1] != NULL)
                config_no = simple_strtoul (argv[1], NULL, 16);
        printf("doing ddrint with config_no %d\n", config_no);
        ddrinit(config_no);
	return 0;
}
U_BOOT_CMD(ddrtest, 2, 1, do_pilot4_ddrtest,
        "Do P4 DDR TEst\n",
        "ddrtest <configno> - \n"
	"ddrtest jump memaddr(First load the program to this addr using a tftp or fatload\n"
        ""
);
...
tU32 ddrinit(tU8 ddr_type){
  ...
  *(tPVU32)(MC_REG_ADDRESS10) = (*(tPVU32)(MC_REG_ADDRESS10) & 0xfffffdff) | 0x00000200;
  ...
  // nc_printf("DDR3 Initialized Started\n");
  
  *(tPVU32)(MC_REG_ADDRESS80) = (*(tPVU32)(MC_REG_ADDRESS80) & 0xfffff000) | 0x00000fff;

  // PHY related. DFIDRAMCLKDISABLE = 1'b1. and odd_wr_latency - bit 5, odd_rd_latency - bit 4.
#if defined (WL5RL6)
  *(tPVU32)(PHY_REG_ADDRESS00) = (*(tPVU32)(PHY_REG_ADDRESS00) & 0xfffffcf7) | 0x00000308;
#endif
#if defined (WL6RL6)
  *(tPVU32)(PHY_REG_ADDRESS00) = (*(tPVU32)(PHY_REG_ADDRESS00) & 0xfffffcf7) | 0x00000008;
#endif
#if defined (WL6RL7)
  ...
  *(tPVU32)(APB_REG_ADDRESS00) = (*(tPVU32)(APB_REG_ADDRESS00) & 0x00000000) | 0x80310301; 
#endif
#if defined (DDR3)
  *(tPVU32)(APB_REG_ADDRESS00) = (*(tPVU32)(APB_REG_ADDRESS00) & 0x00000000) | 0x80210101;
#endif
#if defined (DDR3L)
  ...
  *(tPVU32)(APB_REG_ADDRESS04) = (*(tPVU32)(APB_REG_ADDRESS04) & 0x00000000) | 0xe0318801;
...
*(tPVU32)(APB_REG_ADDRESS08) = (*(tPVU32)(APB_REG_ADDRESS08) & 0x00000000) | 0x00000166;
...
#else
#if defined (DDR3_75_125MHZ)
  *(tPVU32)(APB_REG_ADDRESS0C) = (*(tPVU32)(APB_REG_ADDRESS0C) & 0x00000000) | 0x00080207;
#endif
#if defined (DDR3_200_250MHZ)
  *(tPVU32)(APB_REG_ADDRESS0C) = (*(tPVU32)(APB_REG_ADDRESS0C) & 0x00000000) | 0x00080207;
#endif
...
#endif
#if defined (DDR3_800MHZ)
  *(tPVU32)(APB_REG_ADDRESS0C) = (*(tPVU32)(APB_REG_ADDRESS0C) & 0x00000000) | 0x00080237;
#endif
#if defined (DDR3_1066MHZ)
  *(tPVU32)(APB_REG_ADDRESS0C) = (*(tPVU32)(APB_REG_ADDRESS0C) & 0x00000000) | 0x00080237;
#endif
...
#endif
#if defined (DDR3_1066MHZ)
  *(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xb585b544;
#endif
#if defined (DDR3_1333MHZ)
  *(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xd696d645;
#endif
#if defined (DDR3_1600MHZ)
#if defined (DDR4)
  //*(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xe7a7f766;
  *(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xe0a0e050;
#else
  //*(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xe747e746;
  *(tPVU32)(APB_REG_ADDRESS10) = (*(tPVU32)(APB_REG_ADDRESS10) & 0x00000000) | 0xe040e040;
#endif
#endif

  // Read FIFO setting. Big value initially. FIFO Training later. 
  *(tPVU32)(APB_REG_ADDRESS14) = (*(tPVU32)(APB_REG_ADDRESS14) & 0x00000000) | 0x000000b1; // was 41.
  ...
  *(tPVU32)(APB_REG_ADDRESS1C) = (*(tPVU32)(APB_REG_ADDRESS1C) & 0x00000000) | 0x00000006;
  ...
  // ZQODT Control.
#if defined (DDR4)
  *(tPVU32)(APB_REG_ADDRESS20) = (*(tPVU32)(APB_REG_ADDRESS20) & 0x00000000) | 0x02467777;
#else
  *(tPVU32)(APB_REG_ADDRESS20) = (*(tPVU32)(APB_REG_ADDRESS20) & 0x00000000) | 0x02557777;
#endif

  // DQS Vref code setting.
#if defined (DDR4)
  //*(tPVU32)(APB_REG_ADDRESS28) = (*(tPVU32)(APB_REG_ADDRESS28) & 0x00000000) | 0x8065819a;
  ...
  *(tPVU32)(APB_REG_ADDRESS20C) = (*(tPVU32)(APB_REG_ADDRESS20C) & 0x00000000) | 0x00ff0100;
  *(tPVU32)(APB_REG_ADDRESS210) = (*(tPVU32)(APB_REG_ADDRESS210) & 0x00000000) | 0x00ff0100;
#endif
  ...
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & 0xf1ffffff) | 0x04000000;
#else
...
//BOARD_DELAY_ONE_CLK. rd2wr delay for certain latencies.
...
#endif
        if (eye_training(upper_dword, lower_dword)) {
#if defined (HW_ENV)
  ...
  *(tPVU32)(MC_REG_ADDRESS40) = (*(tPVU32)(MC_REG_ADDRESS40) | 0x00010000);
  ...
  //Write/Read to make sure DDR is initialized properly.
...
void ddrcfg(tU8 ddr_type, tU8 ddr_freq){
  ...
  if (ddr_type == 1) {
    ...
    *(tPVU32)(MC_REG_ADDRESS00) = (*(tPVU32)(MC_REG_ADDRESS00) & ~0xffffffc7) | 0x00007404;
    while(((*(tPVU32)(MC_REG_ADDRESS00)) & 0x1000) != 0);
    // MRS1.
    *(tPVU32)(MC_REG_ADDRESS00) = (*(tPVU32)(MC_REG_ADDRESS00) & ~0xffffffc7) | 0x00063404;
    while(((*(tPVU32)(MC_REG_ADDRESS00)) & 0x1000) != 0);
    // MRS reset DLL.
#if defined (DLL_OFF)
...
tU8 eye_training(tU32 upper_dword, tU32 lower_dword){
  tU32 temp;
...
void ddrsize_calc(tU8 freq_value) {
  ...
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & ~0x000000ff) | trfc10_array[freq_value+8][ddr_tech_type];
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & ~0x01fe0000) | trfc_array[freq_value+8][ddr_tech_type] << 17;
#else
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & 0xf1ffffff) | ddr_tech_type << 25;
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & ~0x000000ff) | trfc10_array[freq_value][ddr_tech_type];
  *(tPVU32)(MC_REG_ADDRESS04) = (*(tPVU32)(MC_REG_ADDRESS04) & ~0x01fe0000) | trfc_array[freq_value][ddr_tech_type] << 17;
#endif
