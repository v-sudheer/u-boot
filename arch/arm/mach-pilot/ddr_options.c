...
#ifdef ASIC_BUILD
#include "pilot_II.h"
#if defined (BOOTLOADER_ONLY)
	#define DEFAULT_PRINTS_BOOTLOADER 1 //This define prints the training results only when bootloader is executed
#endif
#else
//#include "include/pilot_II.h"
#include <asm/arch/pilot_plat.h>
#endif
...
//#if defined (DDR4)
  ...
  *(tPVU32)(APB_REG_ADDRESS00) = (*(tPVU32)(APB_REG_ADDRESS00) & 0x00000000) | 0x803b0301; //option2
//#endif
	} else {
#if defined (DDR3L)
