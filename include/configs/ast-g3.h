...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ramfs=set bootargs console=ttyS4,115200n8 root=/dev/ram rw init=/linuxrc mem=80M\0" \
	"squashfs=set bootargs console=ttyS4,115200n8 root=/dev/mtdblock3 rootfs=squashfs init=/linuxrc mem=80M\0" \
	""
